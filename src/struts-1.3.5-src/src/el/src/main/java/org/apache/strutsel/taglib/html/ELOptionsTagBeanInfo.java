/*
 * $Id: ELOptionsTagBeanInfo.java 376779 2006-02-10 18:08:58Z husted $
 *
 ...
 * <code>org.apache.strutsel.taglib.html.ELOptionsTag</code> class. It is
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            proplist.add(new PropertyDescriptor("collection",
                    ELOptionsTag.class, null, "setCollectionExpr"));
        ...
        try {
            proplist.add(new PropertyDescriptor("labelName",
                    ELOptionsTag.class, null, "setLabelNameExpr"));
        } catch (IntrospectionException ex) {
        }

        try {
            proplist.add(new PropertyDescriptor("labelProperty",
                    ELOptionsTag.class, null, "setLabelPropertyExpr"));
        } catch (IntrospectionException ex) {
        }
        ...
        try {
            proplist.add(new PropertyDescriptor("styleClass",
                    ELOptionsTag.class, null, "setStyleClassExpr"));
        } catch (IntrospectionException ex) {
        }
