/*
 * $Id: ELUseAttributeTagBeanInfo.java 376781 2006-02-10 18:09:48Z husted $
 *
 ...
 * <code>org.apache.strutsel.taglib.tiles.ELUseAttributeTag</code> class.  It
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            proplist.add(new PropertyDescriptor("classname",
                    ELUseAttributeTag.class, null, "setClassnameExpr"));
        } catch (IntrospectionException ex) {
        }

        try {
            proplist.add(new PropertyDescriptor("scope",
                    ELUseAttributeTag.class, null, "setScopeExpr"));
        } catch (IntrospectionException ex) {
        }

        try {
            proplist.add(new PropertyDescriptor("name",
                    ELUseAttributeTag.class, null, "setNameExpr"));
        } catch (IntrospectionException ex) {
        }

        try {
            proplist.add(new PropertyDescriptor("ignore",
                    ELUseAttributeTag.class, null, "setIgnoreExpr"));
        } catch (IntrospectionException ex) {
        }
