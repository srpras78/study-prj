/*
 * $Id: ELOptionsCollectionTagBeanInfo.java 376779 2006-02-10 18:08:58Z husted $
 *
...
public class ELOptionsCollectionTagBeanInfo extends SimpleBeanInfo {
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            proplist.add(new PropertyDescriptor("filter",
                    ELOptionsCollectionTag.class, null, "setFilterExpr"));
        } catch (IntrospectionException ex) {
        }

        try {
            proplist.add(new PropertyDescriptor("label",
                    ELOptionsCollectionTag.class, null, "setLabelExpr"));
        } catch (IntrospectionException ex) {
        }

        try {
            proplist.add(new PropertyDescriptor("name",
                    ELOptionsCollectionTag.class, null, "setNameExpr"));
        } catch (IntrospectionException ex) {
        }

        try {
            proplist.add(new PropertyDescriptor("property",
                    ELOptionsCollectionTag.class, null, "setPropertyExpr"));
        } catch (IntrospectionException ex) {
        }

        try {
            proplist.add(new PropertyDescriptor("style",
                    ELOptionsCollectionTag.class, null, "setStyleExpr"));
        } catch (IntrospectionException ex) {
        }

        try {
            proplist.add(new PropertyDescriptor("styleClass",
                    ELOptionsCollectionTag.class, null, "setStyleClassExpr"));
        } catch (IntrospectionException ex) {
        }

        try {
            proplist.add(new PropertyDescriptor("value",
                    ELOptionsCollectionTag.class, null, "setValueExpr"));
        } catch (IntrospectionException ex) {
        }
